...
function buildIndex() {
  ...
  html = html.replace('</head>', '<link rel="stylesheet" href="/map-enhancer.css?v=12" /></head>');
  html = html.replace(
    '<script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js" crossorigin=""></script>',
    '<script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js" crossorigin=""></script><script src="/map-enhancer-pre.js?v=12"></script>'
  );
  html = html.replace('</body>', '<script src="/map-enhancer.js?v=12"></script></body>');
  return html;
}
